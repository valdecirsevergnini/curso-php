...
if ($nomeusuario == '' || $mail == '' || $senha == '' || $nivelusuario <= 0) {
    die("Preencha todos os campos corretamente.");
}

$sql = "INSERT INTO usuarios (nome_usuario, mail_usuario, senha_usuario, nivel_usuario, status) VALUES ('$nomeusuario', '$mail', sha1('$senha'), $nivelusuario, '$status')";
